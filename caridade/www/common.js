...
/***/ "./src/app/services/api/bazar.service.ts":
/*!***********************************************!*\
  !*** ./src/app/services/api/bazar.service.ts ***!
  \***********************************************/
/*! exports provided: BazarService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BazarService", function() { return BazarService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var BazarService = /** @class */ (function () {
    function BazarService(http) {
        this.http = http;
    }
    BazarService.prototype.getAllBazares = function () {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["SERVER_URL"] + "/Bazar/Todos";
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("Recebido Lista de Bazares"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getAllBazares")));
    };
    BazarService.prototype.handleError = function (operation, result) {
    ...
    BazarService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/services/api/institution.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/services/api/institution.service.ts ***!
  \*****************************************************/
...
var InstitutionService = /** @class */ (function () {
    ...
    InstitutionService.prototype.getAllInstitutions = function () {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["SERVER_URL"] + "/ListInstitution/Todas";
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("Recebido Lista de Institutions"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getAllInstitutions")));
    };
    InstitutionService.prototype.handleError = function (operation, result) {
        if (operation === void 0) { operation = 'operation'; }
        return function (error) {
...
var MenuService = /** @class */ (function () {
    ...
    MenuService.prototype.getMsg = function () {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["SERVER_URL"] + "/Mensagem";
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("recebi Texto "); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getMsg")));
    };
    MenuService.prototype.handleError = function (operation, result) {
        if (operation === void 0) { operation = 'operation'; }
        return function (error) {
            // TODO: send the error to remote logging infrastructure
            console.error(error); // log to console instead
